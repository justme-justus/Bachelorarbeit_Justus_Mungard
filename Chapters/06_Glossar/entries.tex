...
{
        name=Secure Shell,
        description=Verschlüsseltes Protokoll für Fernzugriffe auf Kommandozeilen
} 
\newglossaryentry{DNS UPDATE}
{
        name=DNS UPDATE,
        description=Erweiterung des DNS für dynamische Zonenupdates
}
