...
\newglossaryentry{OSI-Schichtenmodell}
{
        ...
        description={Das Open Systems Interconnection-Schichtenmodell stellt verschiedene Funktionen und Schnittstellen in der Netzwerkvermittlung in Schichten 1 bis 7 abstrahiert dar}
}
...
{
        name=Backbone,
        description={Dreiecks-Topologie aus AWS, Azure und Private Cloud}
} 
\newglossaryentry{Zone}
{
        name=Zone,
        description={Speicherung von DNS-Informationen in einem autoritativen Nameserver}
} 
