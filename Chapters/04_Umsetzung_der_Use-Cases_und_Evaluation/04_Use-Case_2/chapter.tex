...
Der Filterausdruck mit \filettt{grep} ist für IPv4-Adressen und macht das Verbindungs-Log übersichtlicher.
%TC:ignore
...
%TC:endignore
\newpage
Um den Fallback zu testen, wurde eine spezielle \filettt{iptables}-Regel eingerichtet, die ausgehende Pakete, in denen der String \glqq vpn\grqq{} (für vpn.ba.mungard.de - DNS ist Klartext!) enthalten ist, verwirft. \textit{vpn-default} bleibt hingegen erlaubt: Die Regel wird über der erstgenannten Regel ausgewertet.
%TC:ignore
