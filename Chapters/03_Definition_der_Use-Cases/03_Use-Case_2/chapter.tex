\section{Use Case 2: \gls{Roadwarrior}-\gls{VPN}}
...
\begin{itemize}
\item Bei AWS werden \gls{Client-to-Site}-Verbindungen eingehend geNATted (\textit{NAT Masquerading}). Damit sind alle \gls{Client}s intern mit der gleichen Absender-IP zu sehen. Dies verletzt den Anspruch der Arbeit, eine Ende-zu-Ende-Konnektivität zu ermöglichen.
