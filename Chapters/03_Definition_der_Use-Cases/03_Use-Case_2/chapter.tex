...
%https://azuremarketplace.microsoft.com/en-us/marketplace/apps/sentriumsl.vyos-1-2-lts-on-azure
...
%https://web.archive.org/web/20210125172757/https://docs.netgate.com/manuals/pfsense/en/latest/the-pfsense-documentation.pdf
%tf remote
...
%Split-DNS S.565-567 TCP/IP Illustrated
%Bind GeoIP Extension: https://kb.isc.org/docs/aa-01149
...
\begin{itemize}
%https://bind9.readthedocs.io/en/latest/reference.html?highlight=rrset-order#rrset-ordering
...
\begin{lstlisting}[label=bind-mmdb-compiler-flag,caption=Das Ubuntu 20.04 Standardpaket wurde bereits mit dem Flag kompiliert.]
...
%DNS UPDATE S.555-558 TCP/IP Illustrated
...
Als stellvertretender \glqq Applikations-Server\grqq{} soll ein simpler Apache2 pro Standort in einer Ubuntu-VM installiert werden. Dieser soll unter über die Domain www.intern.ba.mungard.de erreichbar sein.
